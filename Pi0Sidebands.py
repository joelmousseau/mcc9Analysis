...
inclusiveMuons = '''[muonTracks.query('track_mcs_mom_count == 1 & mc_channel == "QE"')['VAR'].to_numpy(), muonTracks.query('track_mcs_mom_count == 1 & mc_channel == "RES"')['VAR'].to_numpy(), muonTracks.query('track_mcs_mom_count == 1 & mc_channel == "DIS"')['VAR'].to_numpy(), muonTracks.query('track_mcs_mom_count == 1 & mc_channel == "2p2h"')['VAR'].to_numpy(), muonTracks.query('track_mcs_mom_count == 1 & mc_channel == "NC / Other"')['VAR'].to_numpy(), extMuons.query('track_mcs_mom_count == 1')['VAR'].to_numpy()]'''

inclusiveProtons = '''protonTracks.query('track_mcs_mom_count == 1 & mc_channel == "QE"')['VAR'].to_numpy(), protonTracks.query('track_mcs_mom_count == 1 & mc_channel == "RES"')['VAR'].to_numpy(), protonTracks.query('track_mcs_mom_count == 1 & mc_channel == "DIS"')['VAR'].to_numpy(), protonTracks.query('track_mcs_mom_count == 1 & mc_channel == "2p2h"')['VAR'].to_numpy(), protonTracks.query('track_mcs_mom_count == 1 & mc_channel == "NC / Other"')['VAR'].to_numpy(), extProtons.query('track_mcs_mom_count == 1')['VAR'].to_numpy()'''

onePMuons = '''[muonTracks.query('track_mcs_mom_count == 1 & mc_channel == "QE" & track_range_mom_p_count == 1')['VAR'].to_numpy(), muonTracks.query('track_mcs_mom_count == 1 & mc_channel == "RES" & track_range_mom_p_count == 1')['VAR'].to_numpy(), muonTracks.query('track_mcs_mom_count == 1 & mc_channel == "DIS" & track_range_mom_p_count == 1')['VAR'].to_numpy(), muonTracks.query('track_mcs_mom_count == 1 & mc_channel == "2p2h" & track_range_mom_p_count == 1')['VAR'].to_numpy(), muonTracks.query('track_mcs_mom_count == 1 & mc_channel == "NC / Other" & track_range_mom_p_count == 1')['VAR'].to_numpy(), extMuons.query('track_mcs_mom_count == 1 & track_range_mom_p_count == 1')['VAR'].to_numpy()]'''

onePProtons = '''[protonTracks.query('track_mcs_mom_count == 1 & mc_channel == "QE" & track_range_mom_p_count == 1')['VAR'].to_numpy(), protonTracks.query('track_mcs_mom_count == 1 & mc_channel == "RES" & track_range_mom_p_count == 1')['VAR'].to_numpy(), protonTracks.query('track_mcs_mom_count == 1 & mc_channel == "DIS" & track_range_mom_p_count == 1')['VAR'].to_numpy(), protonTracks.query('track_mcs_mom_count == 1 & mc_channel == "2p2h" & track_range_mom_p_count == 1')['VAR'].to_numpy(), protonTracks.query('track_mcs_mom_count == 1 & mc_channel == "NC / Other" & track_range_mom_p_count == 1')['VAR'].to_numpy(), extProtons.query('track_mcs_mom_count == 1 & track_range_mom_p_count == 1')['VAR'].to_numpy()]'''

nPMuons = '''[muonTracks.query('track_mcs_mom_count == 1 & mc_channel == "QE" & track_range_mom_p_count > 0')['VAR'].to_numpy(), muonTracks.query('track_mcs_mom_count == 1 & mc_channel == "RES" & track_range_mom_p_count > 0')['VAR'].to_numpy(), muonTracks.query('track_mcs_mom_count == 1 & mc_channel == "DIS" & track_range_mom_p_count > 0')['VAR'].to_numpy(), muonTracks.query('track_mcs_mom_count == 1 & mc_channel == "2p2h" & track_range_mom_p_count > 0')['VAR'].to_numpy(), muonTracks.query('track_mcs_mom_count == 1 & mc_channel == "NC / Other" & track_range_mom_p_count > 0')['VAR'].to_numpy(), extMuons.query('track_mcs_mom_count == 1 & track_range_mom_p_count > 0')['VAR'].to_numpy()]'''

nPProtons = '''[protonTracks.query('track_mcs_mom_count == 1 & mc_channel == "QE" & track_range_mom_p_count> 0 & isLeadingP == True')['VAR'].to_numpy(), protonTracks.query('track_mcs_mom_count == 1 & mc_channel == "RES" & track_range_mom_p_count > 0 & isLeadingP == True')['VAR'].to_numpy(), protonTracks.query('track_mcs_mom_count == 1 & mc_channel == "DIS" & track_range_mom_p_count > 0 & isLeadingP == True')['VAR'].to_numpy(), protonTracks.query('track_mcs_mom_count == 1 & mc_channel == "2p2h" & track_range_mom_p_count > 0 & isLeadingP == True')['VAR'].to_numpy(), protonTracks.query('track_mcs_mom_count == 1 & mc_channel == "NC / Other" & track_range_mom_p_count > 0 & isLeadingP == True')['VAR'].to_numpy(), extProtons.query('track_mcs_mom_count == 1 & track_range_mom_p_count > 0 & isLeadingP == True')['VAR'].to_numpy()]'''

onePMuons = '''[muonTracks.query('track_mcs_mom_count == 1 & mc_channel == "QE" & track_range_mom_p_count == 1')['VAR'].to_numpy(), muonTracks.query('track_mcs_mom_count == 1 & mc_channel == "RES" & track_range_mom_p_count == 1')['VAR'].to_numpy(), muonTracks.query('track_mcs_mom_count == 1 & mc_channel == "DIS" & track_range_mom_p_count == 1')['VAR'].to_numpy(), muonTracks.query('track_mcs_mom_count == 1 & mc_channel == "2p2h" & track_range_mom_p_count == 1')['VAR'].to_numpy(), muonTracks.query('track_mcs_mom_count == 1 & mc_channel == "NC / Other" & track_range_mom_p_count == 1')['VAR'].to_numpy(), extMuons.query('track_mcs_mom_count == 1 & track_range_mom_p_count == 1')['VAR'].to_numpy()]'''

onePProtons = '''[protonTracks.query('track_mcs_mom_count == 1 & mc_channel == "QE" & track_range_mom_p_count == 1')['VAR'].to_numpy(), protonTracks.query('track_mcs_mom_count == 1 & mc_channel == "RES" & track_range_mom_p_count == 1')['VAR'].to_numpy(), protonTracks.query('track_mcs_mom_count == 1 & mc_channel == "DIS" & track_range_mom_p_count == 1')['VAR'].to_numpy(), protonTracks.query('track_mcs_mom_count == 1 & mc_channel == "2p2h" & track_range_mom_p_count == 1')['VAR'].to_numpy(), protonTracks.query('track_mcs_mom_count == 1 & mc_channel == "NC / Other" & track_range_mom_p_count == 1')['VAR'].to_numpy(), extProtons.query('track_mcs_mom_count == 1 & track_range_mom_p_count == 1')['VAR'].to_numpy()]'''

twoPMuons = '''[muonTracks.query('track_mcs_mom_count == 1 & mc_channel == "QE" & track_range_mom_p_count == 2')['VAR'].to_numpy(), muonTracks.query('track_mcs_mom_count == 1 & mc_channel == "RES" & track_range_mom_p_count == 2')['VAR'].to_numpy(), muonTracks.query('track_mcs_mom_count == 1 & mc_channel == "DIS" & track_range_mom_p_count == 2')['VAR'].to_numpy(), muonTracks.query('track_mcs_mom_count == 1 & mc_channel == "2p2h" & track_range_mom_p_count == 2')['VAR'].to_numpy(), muonTracks.query('track_mcs_mom_count == 1 & mc_channel == "NC / Other" & track_range_mom_p_count == 2')['VAR'].to_numpy(), extMuons.query('track_mcs_mom_count == 1 & track_range_mom_p_count == 2')['VAR'].to_numpy()]'''

twoPProtons = '''[protonTracks.query('track_mcs_mom_count == 1 & mc_channel == "QE" & track_range_mom_p_count == 2 & isLeadingP == True')['VAR'].to_numpy(), protonTracks.query('track_mcs_mom_count == 1 & mc_channel == "RES" & track_range_mom_p_count == 2 & isLeadingP == True')['VAR'].to_numpy(), protonTracks.query('track_mcs_mom_count == 1 & mc_channel == "DIS" & track_range_mom_p_count == 2 & isLeadingP == True')['VAR'].to_numpy(), protonTracks.query('track_mcs_mom_count == 1 & mc_channel == "2p2h" & track_range_mom_p_count == 2 & isLeadingP == True')['VAR'].to_numpy(), protonTracks.query('track_mcs_mom_count == 1 & mc_channel == "NC / Other" & track_range_mom_p_count == 2 & isLeadingP == True')['VAR'].to_numpy(), extProtons.query('track_mcs_mom_count == 1 & track_range_mom_p_count == 2 & isLeadingP == True')['VAR'].to_numpy()]'''
...
makeDataMCHistogram(onePMomentumStack, onePMuonWeights,dataMuons.query('track_range_mom_p_count == 1 & track_mcs_mom_count ==1')['track_mom_best'].to_numpy(), muonMomentumRange, 18, "OnePMuonP", ["Your mom"])
figNumber = figNumber + 1
